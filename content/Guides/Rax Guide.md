...
| 19         | Castle                      |
| 19         | 2nd Production building     |
| 19         | Worker                      |

Very normal to cancel third raider and expand faster if you see its a mirror match up. 
...
| 8          | House                       |
| 9          | Rax                         |
| ༼ つ ◕_◕ ༽つ | Go to 11 workers, 2 raiders |
| 15         | Castle                      |
| 15         | raider                      |
| 17         | worker                      |
| 18         | raider                      |
...
###### **"It's an older build sir, but it checks out"**
 Its less forgiving to small mistakes and has less aggressive potential, but still very strong. I still personally think of this version of the opening as the **Sqrtofneg1** build to this day, specifically when playing a 24 or 26 supply 3rd castle off 1 house. I am not sure who came up with it but Sqrt did it the best and often when I started playing hence the association.
...
**General catapult timing logic:**
- At some point once becoming saturated on 3 base drop a couple of workshops, then a 4th base (or vice versa).
- If you go workshops first → drop the 4th before actually starting catas. You don't want to fall too far behind in eco.
- Adv. workshop is a natural pairing with the workshops to begin cata dropping.
