---
title: Beast Guide
description: DC and Haffey beast openings, workshop matchups, and mid-game transitions.
cssclasses:
  - guide-page
---
...
9 Den
13 worker & 3 wolves
down below are three variations

(Vs No Raider)
19 Castle > 2nd den > worker
...
2. Invisible WW or dragons are incredibly powerful in the late game.

---

## Tips

- Buildings are very expensive and slow to repair your primary targets will be houses and castles or any exposed building, you always want to be fishing for opportunities to dish out free damage on buildings.
- Typical of faster army compositions whenever dealing with moveouts you really want to always make sure you get behind them early as possible to cut off their rally then stall as long as you can to build a large rally for yourself then attempt to sandwich them when you cant stall any longer or before the opportunity to trap them slips away.
- Whenever playing with wolves if you have the spare apm or micro, it is a very good idea if you aren't surrounding them to try and use 1 wolf dancing around behind their army when engaging this has very frustrating effects on their units when they try to a move the back half will try to chase after the wolf often really screwing up the fight for them once there is enough ranged units in play though this option isn't as useful. You can extend this to other areas for instance when harassing an area try to use a wolf to delay their responding units. They will often just be a moved toward the area in danger and if they aren't watching its quite easy to get them to chase after 1 wolf and lead them around until they notice and fix the pathing. when multiprong attacking this becomes far more effective any extra time we buy ourselves to hit their buildings or vulnerable units the better.
